...
// TODO: Agregar imágenes específicas para Neveras y Lavadoras en src/img/categorias/
...
// Datos de las categorías con las rutas correctas (sin IM)
const categories = [
  {
    id: 1,
    title: "Neveras",
    ...
    description: "Tecnología Bespoke AI para tu cocina",
  },
  {
    id: 2,
    title: "Lavadoras",
    ...
    description: "Lavado inteligente con AI Ecobubble",
  },
  {
    id: 3,
