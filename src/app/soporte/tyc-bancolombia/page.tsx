...
export default function TyCBancolombiaPage() {
  return (
    <LegalDocumentLayout
      title="Términos y Condiciones - 0% de Interés Bancolombia"
      sections={sections}
      ...
      <div className="space-y-16">
        <section id="identificacion">
          ...
          <div className="bg-gray-50 border border-gray-200 p-8 space-y-4">
            <h3 className="text-xl font-semibold text-black">
              Promoción: 0% de Interés con Tarjetas de Crédito Bancolombia
            </h3>
            <div className="grid gap-3 text-gray-700">
              <div className="flex">
                <span className="font-semibold min-w-[140px]">Vigencia:</span>
                <span>Del 1 de julio de 2025 al 31 de diciembre de 2025</span>
              </div>
              <div className="flex">
        ...
        <section id="vigencia">
          ...
          <p className="text-gray-700 leading-relaxed mb-6 text-lg">
            ...
            <strong>1 de julio de 2025</strong> hasta el{" "}
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                content:
                  "La aprobación de la compra a crédito está sujeta a las políticas y condiciones de Bancolombia S.A. IMAGIQ no tiene injerencia en las decisiones crediticias del banco emisor de la tarjeta.",
              },
              {
                num: "3",
              ...
              },
              {
                ...
                content:
                  "Al realizar una compra bajo esta promoción, el cliente acepta expresamente todos los términos y condiciones aquí establecidos, así como las políticas generales de IMAGIQ y las condiciones del contrato de tarjeta de crédito con Bancolombia.",
              },
            ].map((item) => (
